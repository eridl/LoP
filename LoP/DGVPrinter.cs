...
namespace DGVPrinterHelper //AllocationRequest
{
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Times New Roman", 12, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Times New Roman", 14, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("Times New Roman", 12, FontStyle.Regular, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Times New Roman", 12, FontStyle.Regular, GraphicsUnit.Point);
